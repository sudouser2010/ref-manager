...
def generate_authors_from_list(author_list):
    """
    ...
    if reference["type"] == "article":
        ...
        if authors:
            if special:
                ...
                authors_fragment = generate_authors_from_list(reference["authors"])
        #----------------------------------------generate authors from list
...
def generate_references(references):
    ...
    for reference in references:
        print generate_reference(reference)
        print ""
...
class generateReferenceTest(unittest.TestCase):
    ...
    def test_generate_authors_from_list(self):
        authors = generate_authors_from_list(self.authors)
    ...
    def test_generate_reference(self):
        reference = generate_reference(self.list_data)
...
print generate_references( json.loads(text_data) )
#unittest.main()
